...
const fileType = require("file-type");
  ...
  img2url("./" + type.ext).then(async url => {
    try{
    await conn.sendMessage(from, { image: await getBuffer('https://vihangayt.me/tools/toanime?url='+url), caption: "⦁ ᴅᴀʀᴋ-ʏᴀꜱʜ-ᴍᴅ ⦁"}, { quoted: mek })
  } catch (e) {
    ...
    await conn.sendMessage(from, { image: { url: apilist.xz +'api/toanime?url='+url+'&apikey=' + apikey }, caption: "⦁ ᴅᴀʀᴋ-ʏᴀꜱʜ-ᴍᴅ ⦁"}, { quoted: mek })
  }
});
